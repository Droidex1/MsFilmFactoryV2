...
import os
req_channel = int(os.environ.get('REQ_CHANNEL', '-1001865437525'))
...
async def next_page(bot, query):
    ...
    btn.insert(1,[ InlineKeyboardButton(text="🔥More Groups", url='https://t.me/ChostEngine/262'), InlineKeyboardButton(text="Mdisk Group Ⓜ️", url='https://t.me/ChostEngine/266') ]
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⚡ Movies Updates ⚡', url=f"https://telegram.me/Cinemahost1"),
            InlineKeyboardButton('🔔 BOT Updates 🤖', url='https://t.me/+8iLGRURyxXdkYjQ1')
            ],[
    ...
    if not spoll:
        ...
        if 2 < len(message.text) < 100:
            ...
            if not files:
                ...
                l = await message.reply_text(text=f"△ 𝙷𝚎𝚢! {message.from_user.first_name} 😎,\n\n🥺Sry,we Dont have Your files Now!\n**❤️Dont Worry!, 𝖸𝗈𝗎𝗋 𝖱𝖾𝗊𝗎𝖾𝗌𝗍 𝖧𝖺𝗌 𝖻𝖾𝖾𝗇 𝖭𝗈𝗍𝖾𝖽 𝖡𝗒 𝖺𝖽𝗆𝗂𝗇 ✅ !**\n Pʟᴇᴀsᴇ ᴡᴀɪᴛ😅!,Cᴏᴍᴇ ᴀɴᴅ ᴄʜᴇᴄᴋ ᴀғᴛᴇʀ Sᴏᴍᴇ ᴛɪᴍᴇ⏳\nᴡᴇ ᴡɪʟʟ Uᴘʟᴏᴀᴅ ɪᴛ ᴀs sᴏᴏɴ⚡.\n\n➟ 📝𝗖𝗼𝗻𝘁𝗲𝗻𝘁 : {search}\n➟ 👤𝗕𝘆 𝗨𝘀𝗲𝗿 : {message.from_user.first_name}\n\n⚠️Nᴏᴛᴇ~\n✪𝗖𝗵𝗲𝗰𝗸 𝗦𝗽𝗲𝗹𝗹𝗶𝗻𝗴 𝗶𝗻 𝗚𝗼𝗼𝗴𝗹𝗲 & 𝗧𝗿𝘆 𝗔𝗴𝗮𝗶𝗻🔎\n✪𝗞𝗶𝗻𝗱𝗹𝘆,𝗱𝗼𝗻𝘁 𝗥𝗲𝗽𝗲𝗮𝘁 𝘁𝗵𝗲 𝘀𝗮𝗺𝗲 𝗥𝗲𝗾𝘂𝗲𝘀𝘁!🗨️\n\n«Dᴠᴅʀɪᴘ & Tᴊᴇᴀᴛʀᴇ Pʀɪᴍᴛ ᴀʀᴇ Nᴏᴛ Aᴠᴀɪʟᴀʙʟᴇ»\n\n༺@cinemahost1 |@huntlinks༻\n\n🦋・‥✰𝘼𝘿𝙈𝙞𝙉 𝙨𝙪𝙥𝙥𝙤𝙧𝙩 ✰‥・🦋\n╰┈➤・☆ @Askadminbot\n╰┈➤・☆ @simply_host",reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("━ • ▌║  🥺Aᴅᴅ ᴍᴇ ᴛᴏ Yᴏᴜʀ Gʀᴏᴜᴘ+  ║▌ • ━", url=f'http://t.me/{temp.U_NAME}?startgroup=true')],[InlineKeyboardButton("🍟 𝑵𝒆𝒘 𝑼𝒑𝒍𝒐𝒂𝒅𝒔 📃", url="https://t.me/+Ja7SvobwfQpiN2I1"), InlineKeyboardButton("🎥 𝒀𝒐𝒖𝑻𝒖𝒃𝒆 ❤️", url="https://www.youtube.com/@cinemahost_tamil")],[InlineKeyboardButton("✅ 𝐌𝐚𝐢𝐧 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 ✅", url="https://t.me/Cinemahost1"),InlineKeyboardButton("⚠️ 𝗨𝗽𝗱𝗮𝘁𝗲𝘀 ⚠️", url="https://t.me/nasa_bots")],[InlineKeyboardButton("╚»♥️ 𝐑𝐞𝐩𝐥𝐲 𝐓𝐡𝐚𝐧𝐤𝐬 ♥️«╝", callback_data="close_data")]]))
